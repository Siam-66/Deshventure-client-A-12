...
const ManageStories = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h2 className="text-3xl font-bold text-center text-gray-800 mb-8 dark:text-gray-200">My Stories</h2>
      ...
      {stories.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {stories.map((story) => (
            <div key={story._id}  className="bg-base-200 dark:bg-gray-900  rounded-lg shadow-lg overflow-hidden cursor-pointer transform transition duration-300 hover:scale-105">
              ...
              {/* Story Content */}
              <div className="p-4">
                <h3 className="text-xl font-semibold h-20 mb-2 dark:text-gray-200">{story.title}</h3>
                <p className="text-gray-600 h-50 mb-4 dark:text-gray-400">
